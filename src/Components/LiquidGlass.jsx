...
const LiquidGlass = () => {
  useEffect(() => {
    ...
    // Update position of the container to follow the mouse
    const halfWidth = this.width / 2;
    const halfHeight = this.height / 2;
    const x = mouseX - halfWidth;
    const y = mouseY - halfHeight;
    ...
    this.mouse.y = (mouseY - rect.top) / rect.height;

    this.updateShader();
  });

  // Optional: handle window resize to keep glass within view
